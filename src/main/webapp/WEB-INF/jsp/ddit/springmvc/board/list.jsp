    ...
    <script type="text/javaScript" language="javascript" defer="defer">
       <!--
        ...
        function fn_egov_select(id) {
        	document.listForm.boardSn.value = id;
        	...
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				<td align="center" class="listtd"><c:out value="${paginationInfo.totalRecordCount+1 - ((boardVO.pageIndex-1) * boardVO.pageSize + status.count)}"/></td>
            				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.boardSn}"/>')"><c:out value="${result.boardSn}"/></a></td>
